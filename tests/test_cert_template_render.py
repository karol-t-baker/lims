...
def test_docx_geometry_changed(db):
    ...
    assert 'w:w="2393"' in xml, "requirement (col 2) not sized to 42mm"
    assert 'w:w="2336"' in xml, "result (col 3) not narrowed to 41mm"
    assert 'w:w="1170"' in xml, "method column not widened to 20.6mm"
