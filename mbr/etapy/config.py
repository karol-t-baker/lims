...
ETAPY_ANALIZY = {
    ...
    "Chegina_K40GLO": {
        ...
        "czwartorzedowanie": {
            ...
            "kroki": [
                {"nr": 1, "label": "Po 1. porcji ługu", "parametry": ["ph_10proc", "nd20", "barwa_fau", "barwa_hz", "metnosc_fau"]},
                {"nr": 2, "label": "Po 2. porcji ługu", "parametry": ["ph_10proc", "nd20", "aa", "barwa_fau", "barwa_hz", "metnosc_fau"]},
            ],
        },
        "sulfonowanie": {"label": "Sulfonowanie", "korekty": ["Na2SO3"]},
        "utlenienie": {
            ...
            "kroki": [
                {"nr": 1, "label": "Obniżenie pH", "parametry": ["ph_10proc", "nd20", "barwa_fau", "barwa_hz", "metnosc_fau", "so3"]},
                {"nr": 2, "label": "Utlenianie perhydrolem", "parametry": ["ph_10proc", "nd20", "barwa_fau", "barwa_hz", "metnosc_fau", "so3", "nacl"]},
            ],
        },
        "rozjasnianie": {"label": "Rozjaśnianie", "korekty": ["Perhydrol"]},
    },
