...
ETAPY_FULL_GLOL = [
    ...
    {"nr": 7, "nazwa": "Analiza po standaryzacji", "read_only": False, "sekcja_lab": "standaryzacja"},
        ...
        "parametry_lab": {
            "analiza": {
                ...
                "pola": [
                    ...
                    _bezp("barwa_I2",   "Barwa jodowa",   "barwa_I2",  0,     200,   0),
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                ...
                "pola": [
                    ...
                    _bezp("nd20",          "nd20",            "nd20",          1.39,  1.42,  3),
                    _bezp("barwa_hz",      "Barwa Hz",        "barwa_hz",      0,     500,   0),
                    _bezp("barwa_I2",     "Barwa jodowa",           "barwa_I2",     0,     10,    0),
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                ...
                "pola": [
                    ...
                    _titr("h2o2",        "%H2O2",      "h2o2",       0,     0.010, 3),
                    _bezp("barwa_I2",   "Barwa jodowa",      "barwa_I2",  0,     2,     0),
                    _bezp("barwa_hz",    "Barwa Hz",   "barwa_hz",   0,     500,   0),
                    _bezp("nd20",        "nd20",       "nd20",       1.39,  1.42,  3),
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                ...
                "pola": [
                    ...
                    _titr("h2o2",           "%H2O2",                "h2o2",            0,   0.010, 3),
                    _bezp("barwa_I2",      "Barwa jodowa",                "barwa_I2",       0,   1,     0),
                    _titr("wolna_amina",    "wolna amina",          "wolna_amina",     0,   0.5,   2),
                    _bezp("nd20",           "nd20",                 "nd20",            1.39, 1.42, 3),
                ],
            },
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                ...
                "pola": [
                    ...
                    _bezp("barwa_I2",   "Barwa jodowa",           "barwa_I2",   0,    5,    0),
    ...
    # ===== GRUPA 5: Monamidy =====
    {
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                "label": "Analiza końcowa",
                "pola": [
                    _bezp("barwa_I2",   "Barwa jodowa",       "barwa_I2",  0,    6,    0),
    ...
    },
    {
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                "label": "Analiza końcowa",
                "pola": [
                    _bezp("barwa_I2",   "Barwa jodowa",          "barwa_I2",  0,    8,    0),
    ...
    },
    {
        ...
        "parametry_lab": {
            "analiza_koncowa": {
                "label": "Analiza końcowa",
                "pola": [
                    _bezp("barwa_I2",   "Barwa jodowa",          "barwa_I2",  0,     4,    0),
                    _titr("wkt",         "%WKT",           "wkt",        0,     0.5,  2),
