...
PARAMETRY = [
    ...
    {"kod": "metnosc_fau","label": "Mętność FAU",          "skrot": "Mętność FAU","typ": "bezposredni", "precision": 0, "name_en": "Turbidity (FAU)",              "method_code": ""},
    {"kod": "barwa_opis", "label": "Barwa opisowa",        "skrot": "Klarowność","typ": "bezposredni", "precision": 0,  "name_en": "Colour description",           "method_code": ""},
    ...
    {"kod": "la",
     ...
     "metoda_factor": 5.61,
     "precision": 2,
     "name_en": "Amine value [mg KOH/g]",  "method_code": ""},
    {"kod": "lk",
     ...
     "metoda_factor": 5.61,
     "precision": 2,
     "name_en": "Acid value [mg KOH/g]",   "method_code": ""},
    {"kod": "nacl",
    ...
    {"kod": "aa",
     ...
     "metoda_factor": 3.015,
     "precision": 2,
     "name_en": "Amino acid [%]",          "method_code": ""},
    {"kod": "so3",
    ...
    {"kod": "wolna_amina",
     ...
     "metoda_factor": 3.015,
     "precision": 2,
     "name_en": "Free cocamidopropyldimethylamine [%]", "method_code": "L904"},
    {"kod": "sa_epton",
     ...
     "metoda_factor": 3.261,
     "precision": 2,
     "name_en": "Active matter Epton [%]", "method_code": ""},
    ...
    {"kod": "sa",
     ...
     "formula": "sm - nacl - 0.6",
     "precision": 2,
     "name_en": "Active matter [%]",       "method_code": "L932"},

    # --- dodatki (bezposredni) ---
    {"kod": "kwas_ca",  "label": "Kwas cytrynowy [kg]", "skrot": "Kw. cytr.","typ": "bezposredni", "precision": 1, "name_en": "", "method_code": ""},
    {"kod": "kwas_hcl", "label": "Kwas solny HCl [kg]", "skrot": "HCl",      "typ": "bezposredni", "precision": 1, "name_en": "", "method_code": ""},
    {"kod": "woda_kg",  "label": "Dodatek wody",         "skrot": "Woda",     "typ": "bezposredni", "precision": 1, "name_en": "", "method_code": ""},
    {"kod": "nacl_kg",  "label": "Dodatek NaCl",         "skrot": "NaCl",     "typ": "bezposredni", "precision": 1, "name_en": "", "method_code": ""},
    {"kod": "nastaw",   "label": "Nastaw",                "skrot": "Nastaw",   "typ": "bezposredni", "precision": 0, "name_en": "", "method_code": ""},

    # --- binarny (OK / Nie OK) ---
    {"kod": "klarownosc", "label": "Klarowność", "skrot": "Klar.", "typ": "binarny", "precision": 0, "name_en": "", "method_code": ""},
    {"kod": "zelowanie",  "label": "Żelowanie",  "skrot": "Żel.",  "typ": "binarny", "precision": 0, "name_en": "", "method_code": ""},
]
...
ETAPY_BINDINGS = [
    ...
    _b("Chegina_K40GLOL", "rozjasnianie", "metnosc_fau", 5, None, None),
